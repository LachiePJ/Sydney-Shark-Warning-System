...
export default function HowItWorksPage() {
  ...
  const sectionNav = [
    { id: 'essentials', label: 'Start here' },
    { id: 'flow', label: 'Model flow' },
    { id: 'score-bands', label: 'Score bands' },
    { id: 'places', label: 'Location logic' },
    { id: 'evidence', label: 'Research sources' },
    { id: 'species', label: 'Species models' },
    { id: 'inputs', label: 'Live data inputs' },
    ...
    <div className={riskApp.pageBg}>
      ...
      <main className={riskApp.mainArticle}>
        ...
        <section className={`${riskApp.card} ${riskApp.cardPad}`}>
          <p className={riskApp.sectionKicker}>Navigate</p>
        ...
        <section id="essentials" className={`${riskApp.card} ${riskApp.cardPad}`}>
          <details open>
        ...
        <section id="flow" className={`${riskApp.card} ${riskApp.cardPad}`}>
          <details open>
            <summary className="cursor-pointer list-none">
        ...
        <section id="score-bands" className={`${riskApp.card} ${riskApp.cardPad}`}>
          <details>
            <summary className="cursor-pointer list-none">
        ...
        <section id="places" className={`${riskApp.card} ${riskApp.cardPad}`}>
          <details>
            <summary className="cursor-pointer list-none">
        ...
        <section id="evidence" className={`${riskApp.card} ${riskApp.cardPad}`}>
          <details>
            <summary className="cursor-pointer list-none">
        ...
        <section id="inputs" className={`${riskApp.card} ${riskApp.cardPad}`}>
          <details>
            <summary className="cursor-pointer list-none">
        ...
        <section id="limits" className={`${riskApp.card} ${riskApp.cardPad}`}>
          <details>
            <summary className="cursor-pointer list-none">
        ...
        <section id="safety" className={`${riskApp.card} ${riskApp.cardPad}`}>
          <details>
            <summary className="cursor-pointer list-none">
